...
func change_scene(from: Object, to: String, duration: float):
	fade_out(from, to, duration, Color.black)

func fade_out(from: Object, to: String, duration: float, color: Color) -> void:
...
func move_to(from: Object, to: String, duration: float, dir: Vector2):
...
func shrink(from: Object, to: String, duration: float):
	# Create Nodes
...
func slide_rect(from: Object, to: String, duration: float, color: Color, dir: Vector2) -> void:
	var controlRoot = CanvasLayer.new()
...
func horizontal_stripes(from: Object, to: String, duration: float, color: Color, delay = 0.5):
	var controlRoot = CanvasLayer.new()
...
func dual_circles(from: Object, to: String, duration: float, color: Color):
	var controlRoot = CanvasLayer.new()
...
func donut_eye(from: Object, to: String, duration: float, color: Color):
	var controlRoot = CanvasLayer.new()
